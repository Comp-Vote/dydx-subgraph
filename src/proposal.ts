...
import {ProposalCreated, VoteEmitted, ProposalCanceled, ProposalQueued, ProposalExecuted} from "../generated/DydxGovernor/DydxGovernor";
...
export function handleProposalCreated(event: ProposalCreated): void {
  ...
  governance.proposals = governance.proposals.plus(BigInt.fromI32(1));
  governance.save();
}
